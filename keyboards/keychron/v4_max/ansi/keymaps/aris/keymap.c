...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_ansi_61(
        ...
        KC_CAPS, KC_A,    KC_S, KC_D,    KC_F,    KC_G,    KC_H,   KC_J,    KC_K,    KC_L,     KC_SCLN, KC_QUOT, KC_ENT,
                 KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
                                KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, MO(_FN), MO(_FN), KC_RCTL
    ),
    ...
    [WIN_BASE] = LAYOUT_ansi_61(
        ...
        KC_ESC, RGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,    KC_H,              LCTL_T(KC_J), LSFT_T(KC_K), LALT_T(KC_L), RGUI_T(KC_SCLN), KC_QUOT, KC_ENT,
                KC_LSFT,      KC_Z,         KC_X,         KC_C,         KC_V,    KC_B,              KC_N,         KC_M,         KC_COMM,      KC_DOT,          KC_SLSH, KC_RSFT,
                                            KC_LCTL,      KC_LGUI,      KC_LALT, LT(_space,KC_SPC), KC_RALT,      MO(_FN),      MO(_FN),      KC_RCTL
    ),

    [_space] = LAYOUT_ansi_61(
        BAT_LVL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,        KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, _______, MS_BTN3, MS_UP,   MS_BTN2, MS_WHLU,      KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, KC_VOLD, KC_VOLU, KC_MUTE,
        _______, MS_BTN1, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BRID, KC_BRIU, _______,
