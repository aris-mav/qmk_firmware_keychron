...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_61(
        ...
        LT(_esc,KC_ESC), RGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,    KC_H,              LCTL_T(KC_J), LSFT_T(KC_K), LALT_T(KC_L), RGUI_T(KC_SCLN), LT(_esc,KC_QUOT), KC_ENT,
                         KC_LSFT,      KC_Z,         KC_X,         KC_C,         KC_V,    KC_B,              KC_N,         KC_M,         KC_COMM,      KC_DOT,          KC_SLSH,          KC_RSFT,
                                                     KC_LCTL,      KC_LGUI,      KC_LALT, LT(_space,KC_SPC), KC_RALT,      MO(_FN_mod),  MO(_FN1),     KC_RCTL
    ),

    [_space] = LAYOUT_ansi_61(
        _______, KC_BRID, KC_BRIU, _______, _______, _______,      _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,
        _______, _______, MS_BTN3, MS_UP,   MS_BTN2, MS_WHLU,      _______, _______, _______, _______, _______, _______, _______, _______,
        KC_CAPS, MS_BTN1, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MINS, KC_EQL,  _______,
                 _______, KC_CAPS, KC_DEL,  CW_TOGG, LSFT(KC_TAB), KC_BSPC, KC_TAB,  KC_ENT,  KC_LBRC, KC_RBRC, KC_BSLS, _______,
                                   _______, _______, _______,      _______, _______, _______, _______, _______
    ),
    [_esc]   = LAYOUT_ansi_61(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,        KC_F6,   KC_F7,        KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
        _______, _______, _______, _______, _______, _______,      _______, _______,      _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,      KC_HOME, KC_PGDN,      KC_PGUP, KC_END,  KC_UNDS, KC_PLUS, _______,
                 _______, _______, KC_DEL,  CW_TOGG, LSFT(KC_TAB), KC_BSPC, LSFT(KC_TAB), KC_ENT,  KC_LCBR, KC_RCBR, KC_PIPE, _______,
                                   _______, _______, _______,      _______, _______,      _______, _______, _______
    ),

    [_FN_mod] = LAYOUT_ansi_61(
